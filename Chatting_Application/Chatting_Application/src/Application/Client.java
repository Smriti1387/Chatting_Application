...
public class Client implements ActionListener{
 ...
 Client(){
	 ...
	 ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("smriti.jpg"));
...
public static void main(String[] args) {
	...
	try {
	    s=new Socket("127.0.0.1",6002);//Server's ip	,port no.
